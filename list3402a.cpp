...
/// Compute body-mass index from height in centimetres and weight in kilograms
...
struct record {
        ...
        /// Error checking ommittted for brevity
...
void print_table(char sex, const std::vector<record>& records, int threshold) {
    ...
    // If the vectors are empty, print basic statsa
