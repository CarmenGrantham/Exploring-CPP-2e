...
#include "erase_less.h"

/// Extract itmes from a string and store them in a container
...
int main() {
    test("2 3 7 11 13 17 23 29 31 37");             // ERase does nothing
    test("37 31 29 23 17 13 11 7 3 2");             // Erases everything except 37
    test("");
    test("42");                                     // Erase does nothing
    test("10 30 20 40 0 50");                       // Erases 20 and 0
}