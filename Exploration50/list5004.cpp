...
public:
    ...
    person(std::string const& name, std::string const& address, std::string phone) : name_{name}, address_{address}, phone_{phone} {}
...
int main() {
    ...
    people[person{"Ray", "123 Erewho", "555-5555"}] = 42;
    people[person{"Arhtur", "456 Utopia", "123-4567"}] = 10;
