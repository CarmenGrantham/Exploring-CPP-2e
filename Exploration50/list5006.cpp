...
namespace std {
    ...
    public:
        ...
        static rational epsilon() noexcept { return rational(1, numeric_limits<int>::max()-1); }
        static rational round_error() noexcept { return rational(1, numeric_limits<int>::max()); }
        ...
        // The following are meant only for floating-point types, but you have to define them, anyway, even for
        // nonfloating-pointtypes. The values they return do not have to be meaningful
